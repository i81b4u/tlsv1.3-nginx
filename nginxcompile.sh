...
help_message() {
  ...
  Compile nginx 1.17.3 with openssl 1.1.1c, brotli and dynamic tls records support.
...
then
	...
	git checkout OpenSSL_1_1_1c || error_exit "Failed to checkout openssl release."
else
