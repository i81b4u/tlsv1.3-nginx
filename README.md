...
**Before reading any further, I also have a docker [image]([https://hub.docker.com/repository/docker/i81b4u/byo-nginx](https://hub.docker.com/r/i81b4u/byo-nginx)) you can use without having to compile things yourself.**
